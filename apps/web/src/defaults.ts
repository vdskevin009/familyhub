...
export const defaultReimbursements: ReimbursementState = { SchemaVersion: 2, Items: [], Reconciliations: [], CleanupSuggestions: [], ImportantMail: [], LearningDecisions: 0, UnmatchedReimbursements: [] };
