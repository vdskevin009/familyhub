...
- **À votre attention** appears in Today and Inbox. It asks for the missing amount, the primary submission, the secondary submission, or a final balance check instead of treating every detected document as a separate claim.
